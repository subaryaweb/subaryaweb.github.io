<template>
	<Card
		class="mt--12 my-8 mx-4 sm:mx-8 md:mx-12 lg:mx-12 xl:mx-12 2xl:mx-auto mt-24 max-w-screen-2xl shadow-color border-2"
		v-if="!checked"
	>
		<template #title>
			<div class="mt-5 ml-8 text-4xl">專案與貢獻</div>
		</template>
		<template #content>
